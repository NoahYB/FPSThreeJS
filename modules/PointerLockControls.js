( function () {
	...
	const _eulerBody = new THREE.Euler( 0, 0, 0, 'YXZ' );
	...
	class PointerLockControls extends THREE.EventDispatcher {
		...
		constructor( player, domElement ) {
			...
			this.isLocked = false; // Set to constrain the pitch of the player
			...
			this.getDirection = function () {
				...
				return function ( v ) {
					...
					return v.copy( direction ).applyQuaternion( player.quaternion );
			...
			this.moveForward = function ( distance ) {
				...
				_vector.setFromMatrixColumn( player.matrix, 0 );

				_vector.crossVectors( player.up, _vector );

				player.position.addScaledVector( _vector, distance );
